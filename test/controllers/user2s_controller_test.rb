...
class User2sControllerTest < ActionController::TestCase
  ...
  test "should create user2" do
    assert_difference('User2.count') do
      post :create, user2: { company: @user2.company, email: @user2.email, name: @user2.name, title: @user2.title }
    end
  ...
  test "should update user2" do
    patch :update, id: @user2, user2: { company: @user2.company, email: @user2.email, name: @user2.name, title: @user2.title }
    assert_redirected_to user2_path(assigns(:user2))
  end
